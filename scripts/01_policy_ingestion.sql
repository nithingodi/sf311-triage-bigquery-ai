-- Creates and populates the policy_chunks table.
-- This script must run before any other script that references this table.
CREATE OR REPLACE TABLE `@@PROJECT_ID@@.@@DATASET_ID@@.policy_chunks` AS
SELECT * FROM UNNEST([
-- Parking / vehicles
...
-- Services & operations (helpful constraints)
